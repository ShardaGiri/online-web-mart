...
{ const [click, setClick] = useState(false);
  ...
  return (
            ...
            <img src={logo} alt="Company Logo" class="responsive" style={{width:"100px"}}></img>
             ...
             <div className="Search-bar"id={showLinks ?"h":"n"}>
              <Form inline className="Search-form" >
              <FormControl type="text" placeholder="Search for Jewellery" style={{borderRadius:'0'}}/>
            ...
            <div className="links" id={showLinks ?"hidden":"nothidden"}>
             ...
             <NavLink to="/"className="navlink" >
              <span >
              <FaStoreAlt  class="icon"size="20px"/> Locate us
              </span> 
             </NavLink>
             </li>
             <li>
             <NavLink to="/bangle" className="navlink">
               <span >
               <FaRegHeart  class="icon"size="20px"/> WishList
               </span> 
             </NavLink>
             </li>
             </ul>
      ...
      <nav className="navbar">
        ...
        onMouseLeave={onMouseLeave}
          ...
          All Jewellery  <span class="caret"></span>
           </NavLink>
